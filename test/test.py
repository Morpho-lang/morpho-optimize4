...
#   test/sqp, test/pgd, test/penalty, test/unconstrained, test/saddlepoint, test/trustregion  -> converged
...
def parse_mode(filepath: str, file_lines: Sequence[str]) -> Mode:
    ...
    if top in ("sqp", "pgd", "penalty", "unconstrained", "saddlepoint", "trustregion"):
        return Mode.CONVERGED
    return Mode.SMOKE
